...
//** Arm Values **//
////////////////////
	int BARRIER = 1330;	// Potentiometer value for arm to go over 12" barrier
	int LOW = 450;			// Potentiometer value for arm to reach minimum...Actual value is 550-590...Safety 600 is too high
